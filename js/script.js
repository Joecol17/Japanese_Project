(() => {
  ...
  const required = { spinBtn, saveScoreBtn, creditsEl, playerNameInput, reels };
  ...
  // initial reel render (random icons) — guard null elements
  for(let i=0;i<3;i++) if(reels[i]) reels[i].innerHTML = icons[rand(icons.length)];
